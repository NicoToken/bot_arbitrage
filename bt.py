...
# Inisialisasi objek Binance dan Tokocrypto
...
common_pairs = get_common_pairs([binance, tokocrypto])
...
while True:
    ...
    for pair in common_pairs:
        ...
        try:
            ...
            if binance_price and tokocrypto_price:

                min_price = min(tokocrypto_price)
