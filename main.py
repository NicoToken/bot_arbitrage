...
def get_coin_arbitrage(api_key, api_secret):
...
def get_price_for_t_pair(api_key, api_secret, t_pair):
...
prices_dict = get_price_for_t_pair(api_key, api_secret, t_pair)
...
# Input API key, Secret key, and pair from the terminal

api_key = input("Enter your API key: ")

api_secret = input("Enter your API secret: ")

pair = input("Enter the pair (e.g., BTCUSDT): ")

# Get coin arbitrage data

tickers = get_coin_arbitrage(api_key, api_secret)

coin_list = collect_tradeables(tickers)

triangular_pairs_list = structure_triangular_pairs(coin_list)

arbitrage_opportunities = find_arbitrage_opportunities(triangular_pairs_list, api_key, api_secret)
